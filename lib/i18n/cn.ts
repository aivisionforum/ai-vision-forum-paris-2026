...
export const cn: Translations = {
  ...
  tracksSection: {
    ...
    tracks: [
      ...
      },
      {
        ...
        subtitle: "AOSF 与可持续性",
        description: "AOSF 定位：Claw 堆栈的 Linux 基金会。Open Token 作为 AI 算力公共事业。战略三角：AI 工厂（生产）+ Claw 堆栈（执行）+ AOSF（治理）。",
        keywords: ["Open Token", "AOSF", "AI 工厂", "Claw 堆栈"],
      },
    ],
  },
  ...
  scheduleSection: {
    ...
    items: [
      { time: "08:30–09:00", title: "签到 & 咖啡" },
      { time: "09:00–09:15", title: "开幕致辞" },
      { time: "09:15–10:30", title: "圆桌1：智能代理 AI 系统", subtitle: "Claw 堆栈，人机协同", format: "主题演讲 + 圆桌" },
      { time: "10:30–10:45", title: "休息" },
      { time: "10:45–12:00", title: "圆桌2：智能代理 AI 与教育", subtitle: "学习与创造力", format: "主题演讲 + 圆桌" },
      { time: "12:00–13:30", title: "午餐 + AIGC 聚焦展示", subtitle: "演示", format: "演示展示" },
      { time: "13:30–14:45", title: "圆桌3：可信智能代理 AI", subtitle: "治理与安全", format: "主题演讲 + 圆桌" },
      { time: "14:45–15:00", title: "休息" },
      { time: "15:00–16:15", title: "圆桌4：Open Token 与数字公共产品", subtitle: "AOSF 与可持续性", format: "主题演讲 + 圆桌" },
      { time: "16:15–16:45", title: "总结与闭幕" },
      { time: "17:00–19:30", title: "交流晚宴", subtitle: "主题桌", format: "交流" },
    ],
  },
  ...
  aosfSection: {
    ...
    coreFunctionsTitle: "五大战略举措：",
    coreFunctions: [
      "开放代理身份——代理的 OAuth：确保安全互信的统一认证",
      "开放规范标准——意图的 HTML：跨平台理解的通用意图描述语言",
      "编排标准——代理的 Kubernetes：智能代理路由和协调",
      "Open Token——公共 AI 算力：作为公共产品的 AI 计算能力公平分配",
      "代理市场——能力交换：交易能力，而非仅仅是软件",
    ],
    keyStatsTitle: "AOSF 治理 LAMP 从未需要的领域：",
    keyStats: [
      "意图（Intent）——确保 AI 代理追求与人类价值观一致的目标",
      "代理（Agents）——信任协议：认证、能力证书、身份验证",
      "经济协调（Economic Coordination）——可持续资金模式和价值分配",
      "Open Token——AI 算力作为公共事业，非加密货币：AI 计算能力的计量和结算机制",
    ],
    visitAosf: "访问 AOSF",
  ...
  trackPublicGood: {
    ...
    keyTopics: [
      "AOSF 定位：Claw 堆栈的 Linux 基金会",
      "Open Token 作为公共事业：AI 算力的计量、定价和结算",
      "战略三角：AI 工厂（生产）+ Claw 堆栈（执行）+ AOSF（治理）",
      "从开源代码 → 治理自主系统",
      "可持续开源 AI 的资金模式",
      "智能代理时代的社区驱动 AI 开发",
      "代理生态系统的开放标准与互操作性",
    ...
    humanityTitle: "战略三角",
    humanityText: "AI 基础设施的未来建立在三大支柱之上：用于生产的 AI 工厂、用于执行的 Claw 堆栈、用于治理的 AOSF。Open Token 提供计量和结算机制——不是加密货币，而是 AI 算力的公共事业，类似于千瓦时衡量电力。",
